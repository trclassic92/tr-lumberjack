...
CreateThread(function()
    ...
    lumberjack1 = CreatePed(1, 0x94562DD7, ClassicMan, false, true)
    lumberjack2 = CreatePed(1, 0x94562DD7, LumberTR, false, true)
    lumberjack3 = CreatePed(1, 0x94562DD7, sellClassic, false, true)
